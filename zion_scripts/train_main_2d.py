...
from constants import WANDB_KEY, WANDB_ENTITY, WANDB_PROJECT_NAME
import wandb
wandb.login(key=WANDB_KEY)

USE_WANDB = True
EXP_ID = "test_run_v0.1"
WANDB_RUN_NAME = "stardist-h&e2d-v0.10"
...
CKPT_PATH = f"/hpc/group/yizhanglab/zs144/repo/Zion-stardist/zion_assets/models/{EXP_ID}"
